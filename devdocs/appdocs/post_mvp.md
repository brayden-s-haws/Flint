...
14. First SaaS connector batch via PyAirbyte — HubSpot and Salesforce — `sources` — chosen to match the existing Sales demo scenario (HubSpot) and the most common enterprise CRM/payments use 
    (Stripe was implemented as part of the PyAirbyte integration)
