...
TABLE_DESCRIPTION_SYSTEM_MESSAGE: str = (
    ...
    "Use markdown formatting including headings and bold text to make descriptions scannable and useful."
)
...
def build_table_description_prompt(table: Table) -> str:
    ...
    Use a short title (## heading) followed by 4-6 sentences of prose across 2 short paragraphs.
...
operational workflows, or business intelligence. Be specific to the table's content.
    ...
    Do not mention row counts or reference specific personas.
